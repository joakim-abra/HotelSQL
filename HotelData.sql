...
--EMPLOYEES
insert into Employees (first_name, last_name, position, signature) values ('Kim', 'Grellier', 'Reception', 'KGR');
insert into Employees (first_name, last_name, position, signature) values ('Susana', 'Petrus', 'Booking manager','SPS');
insert into Employees (first_name, last_name, position, signature) values ('Kiersten', 'Gravet', 'Reception','KGT');
insert into Employees (first_name, last_name, position, signature) values ('Tonie', 'Pochin', 'Reception','TPN');
insert into Employees (first_name, last_name, position, signature) values ('Andie', 'Charlon', 'Reception','ACN');
insert into Employees (first_name, last_name, position, signature) values ('Claudian', 'Daingerfield', 'Reception','CDD');
insert into Employees (first_name, last_name, position, signature) values ('Silvia', 'Eathorne', 'Reception','SEE');
insert into Employees (first_name, last_name, position, signature) values ('Delmore', 'Toffoloni', 'Reception','DTI');
insert into Employees (first_name, last_name, position, signature) values ('Aubrey', 'Willey', 'Reception','AWY');
insert into Employees (first_name, last_name, position, signature) values ('Constantin', 'Moffat', 'Reception','CMT');
GO
